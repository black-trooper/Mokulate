...
スライドスイッチ取り付け穴に、3Dプリント時のサポート材が残っているのでカッターで取り除きます。
...
スライドスイッチを、**黒色のM2ネジ**（2本）を使って**ボトムケース**に取り付けます。

1. まずスライドスイッチにネジを取り付けます。
...
3.  ゴム足をボトムケース裏の穴に貼り付けます。
4.  組み立てた状態でトップケースの四隅を上から軽く押してみてカタ付きがなければ完成です。  
